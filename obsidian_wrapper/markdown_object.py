...
class MarkdownObject:
    def __init__(self, line: str, index: int, previous_attribute: 'MarkdownObject'):
        ...
        attribute_info = self.__extract_attribute__(previous_attribute=previous_attribute)
    ...
    def __extract_attribute__(self, previous_attribute: str) -> Tuple[str, str, str]:
        ...
        if stripped_line.startswith("-"):
            ...
            if stripped_line[0:2] == "[]":
                return "checkBox", stripped_line, "unchecked" # if number_of_tabs == 0 else f"checkbox-unchecked-nested-{number_of_tabs}"
